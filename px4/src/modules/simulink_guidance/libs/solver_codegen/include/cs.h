...
/* operator wrappers */
double cs_di_divcc(double lhs, double rhs);
double cs_di_mulcc(double lhs, double rhs);
double cs_di_subcc(double lhs, double rhs);
double cs_di_pluscc(double lhs, double rhs);
int cs_di_equalcc(double lhs, double rhs);
double cs_di_createFromDouble(double aVal);
double cs_di_sqrt(double in);
double cs_di_flipSign(double in);
double cs_di_muldc(double lhs, double rhs);
...
cs_long_t cs_dl_fkeep(cs_dl* A,
                      cs_long_t (*fkeep)(cs_long_t, cs_long_t, double, void*),
                      void* other);
...
/* operator wrappers */
double cs_dl_divcc(double lhs, double rhs);
double cs_dl_mulcc(double lhs, double rhs);
double cs_dl_subcc(double lhs, double rhs);
double cs_dl_pluscc(double lhs, double rhs);
int cs_dl_equalcc(double lhs, double rhs);
double cs_dl_createFromDouble(double aVal);
double cs_dl_sqrt(double in);
double cs_dl_flipSign(double in);
double cs_dl_muldc(double lhs, double rhs);
...
/* operator wrappers */
cs_complex_t cs_ci_divcc(cs_complex_t lhs, cs_complex_t rhs);
cs_complex_t cs_ci_mulcc(cs_complex_t lhs, cs_complex_t rhs);
cs_complex_t cs_ci_subcc(cs_complex_t lhs, cs_complex_t rhs);
cs_complex_t cs_ci_pluscc(cs_complex_t lhs, cs_complex_t rhs);
int cs_ci_equalcc(cs_complex_t lhs, cs_complex_t rhs);
cs_complex_t cs_ci_createFromDouble(double aVal);
cs_complex_t cs_ci_sqrt(cs_complex_t in);
cs_complex_t cs_ci_flipSign(cs_complex_t in);
double cs_ci_muldc(double lhs, cs_complex_t rhs);
...
cs_long_t cs_cl_fkeep(cs_cl* A,
                      cs_long_t (*fkeep)(cs_long_t, cs_long_t, cs_complex_t, void*),
                      void* other);
...
/* operator wrappers */
cs_complex_t cs_cl_divcc(cs_complex_t lhs, cs_complex_t rhs);
cs_complex_t cs_cl_mulcc(cs_complex_t lhs, cs_complex_t rhs);
cs_complex_t cs_cl_subcc(cs_complex_t lhs, cs_complex_t rhs);
cs_complex_t cs_cl_pluscc(cs_complex_t lhs, cs_complex_t rhs);
int cs_cl_equalcc(cs_complex_t lhs, cs_complex_t rhs);
cs_complex_t cs_cl_createFromDouble(double aVal);
cs_complex_t cs_cl_sqrt(cs_complex_t in);
cs_complex_t cs_cl_flipSign(cs_complex_t in);
double cs_cl_muldc(double lhs, cs_complex_t rhs);
...
/* operator wrappers */
#define cs_divcc CS_NAME(_divcc)
#define cs_mulcc CS_NAME(_mulcc)
#define cs_subcc CS_NAME(_subcc)
#define cs_pluscc CS_NAME(_pluscc)
#define cs_equalcc CS_NAME(_equalcc)
#define cs_createFromDouble CS_NAME(_createFromDouble)
#define cs_sqrt CS_NAME(_sqrt)
#define cs_flipSign CS_NAME(_flipSign)
#define cs_muldc CS_NAME(_muldc)
